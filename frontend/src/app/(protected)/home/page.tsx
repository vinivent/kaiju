  ...
  const stats = [
    {
      ...
      icon: ShoppingBag,
      color: 'text-primary',
      bgColor: 'from-primary/20 to-primary/10 dark:from-primary/30 dark:to-primary/10',
    },
    {
      ...
      bgColor: 'from-secondary/20 to-secondary/10 dark:from-secondary/30 dark:to-secondary/10',
    },
    {
    ...
    <div className="min-h-screen bg-background">
          ...
          <div className="max-w-5xl mx-auto text-center space-y-8">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center pt-8 animate-in fade-in slide-in-from-bottom-4 duration-700 delay-300">
              ...
              <Link href="/veterinarios">
                <Button variant="outline" className="cursor-pointer group border-1">
      ...
      <section className="container mx-auto px-4 -mt-12 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {stats.map((stat, index) => (
            <Card key={index} className="border-1 hover:shadow-lg transition-all duration-300 hover:-translate-y-1 bg-background/80 backdrop-blur-sm">
            ...
            <Card className="h-full border-1 hover:shadow-2xl transition-all duration-500 overflow-hidden cursor-pointer">
              <CardContent className="p-8 md:p-10">
                ...
                <div className="space-y-4 mb-8">
                  ...
                  <div className="flex items-center gap-3 text-sm">
                    <div className="w-2 h-2 rounded-full bg-primary" />
                    <span>Qualidade garantida pelos melhores especialistas</span>
                  </div>
                  <div className="flex items-center gap-3 text-sm">
                    <div className="w-2 h-2 rounded-full bg-primary" />
      ...
      <section className="container mx-auto px-4 pb-20">
        <div className="text-center mb-12">
          <h2 className="text-3xl md:text-4xl font-bold mb-4">Faça Parte da Nossa Comunidade</h2>
          ...
          <Card className="border-1 overflow-hidden group hover:shadow-2xl transition-all duration-500 hover:-translate-y-2">
            <div className="p-10">
              <div className="flex items-start gap-4 mb-8">
                ...
                <div>
                  <h3 className="text-3xl font-bold mb-2">Seja um Veterinário</h3>
              ...
              <ul className="space-y-4 mb-8">
                <li className="flex items-start gap-3">
                  ...
                  <span className="text-base">Conecte-se com proprietários de répteis</span>
                </li>
                <li className="flex items-start gap-3">
                  <CheckCircle2 className="h-6 w-6 text-primary flex-shrink-0 mt-0.5" />
                  <span className="text-base">Perfil profissional verificado</span>
                </li>
                <li className="flex items-start gap-3">
                  <CheckCircle2 className="h-6 w-6 text-primary flex-shrink-0 mt-0.5" />
                  <span className="text-base">Sistema de chat em tempo real</span>
                </li>
                <li className="flex items-start gap-3">
                  <CheckCircle2 className="h-6 w-6 text-primary flex-shrink-0 mt-0.5" />
                  <span className="text-base">Receba avaliações e feedback</span>
                </li>
              </ul>

              <Link href="/veterinarios">
                <Button className="w-full cursor-pointer bg-primary text-primary-foreground hover:bg-primary/90 group/btn">
                  <UserPlus className="mr-2 h-4 w-4 group-hover/btn:scale-110 transition-transform" />
                  Criar Perfil de Veterinário
            ...
            <div className="p-10">
              ...
              <ul className="space-y-4 mb-8">
                <li className="flex items-start gap-3">
                  ...
                  <span className="text-base">Plataforma completa de e-commerce</span>
                </li>
                <li className="flex items-start gap-3">
                  <CheckCircle2 className="h-6 w-6 text-secondary dark:text-secondary-foreground flex-shrink-0 mt-0.5" />
                  <span className="text-base">Gerencie seus produtos facilmente</span>
                </li>
                <li className="flex items-start gap-3">
                  <CheckCircle2 className="h-6 w-6 text-secondary dark:text-secondary-foreground flex-shrink-0 mt-0.5" />
                  <span className="text-base">Sistema de avaliações e reviews</span>
                </li>
                <li className="flex items-start gap-3">
                  <CheckCircle2 className="h-6 w-6 text-secondary dark:text-secondary-foreground flex-shrink-0 mt-0.5" />
                  <span className="text-base">Alcance milhares de clientes</span>
                </li>
              </ul>

              <Link href="/produtos">
                <Button className="w-full cursor-pointer bg-secondary text-secondary-foreground hover:bg-secondary/90 group/btn">
          ...
          <CardContent className="pt-16 pb-16 text-center relative">
            <div className="max-w-3xl mx-auto space-y-8">
              <div className="inline-flex items-center gap-2 px-5 py-2 rounded-full bg-gradient-to-r from-primary/20 to-primary/20 dark:from-primary/30 dark:to-primary/30 border border-primary/30 dark:border-primary/20 mb-4">
                ...
                <span className="text-sm font-semibold bg-gradient-to-r from-primary to-primary bg-clip-text text-transparent">Cresça com a gente</span>
              </div>
              ...
              <p className="text-xl text-muted-foreground leading-relaxed">
                Explore nossa plataforma e descubra tudo que oferecemos para cuidar do seu réptil
              </p>
