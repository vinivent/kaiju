...
import { ReptileSpecialty, VetStatus, UserRole } from "@/app/types/common";
import { PageHeader } from "@/components/listings/PageHeader";
import {
  FilterBar,
  FilterSelect,
  FilterInput,
} from "@/components/listings/FilterBar";
...
import { CreateVeterinarianForm } from "@/components/forms/CreateVeterinarianForm";
      ...
      >
        <div className="flex flex-wrap gap-2 items-center">
          <FilterSelect
            ...
            onValueChange={(value) =>
              setSelectedSpecialty(value as ReptileSpecialty | "ALL")
            }
            options={specialties}
            icon={Filter}
          ...
          {user?.role === UserRole.VETERINARIAN && (
            <div className="w-full sm:w-auto flex justify-end sm:justify-start">
              <CreateVeterinarianForm onSuccess={loadVeterinarians} />
            </div>
          )}
        </div>
      </FilterBar>
