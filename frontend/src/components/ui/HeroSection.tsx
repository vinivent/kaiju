        ...
        <section className="relative min-h-[90vh] flex items-center overflow-hidden">
            <div className="container mx-auto px-4 relative z-10">
                <div className="grid lg:grid-cols-2 gap-12 items-center">
                    <div className="space-y-8 animate-fade-in">
                        ...
                        <div className="space-y-4">
                            ...
                            <p className="text-lg md:text-xl text-muted-foreground leading-relaxed max-w-2xl">
                                A plataforma completa conectando donos de répteis com veterinários especializados, produtos de qualidade e conhecimento especializado. Tudo em um só lugar.
                            </p>
                        </div>
                    ...
                    <div className="relative lg:block hidden animate-scale-in" style={{ animationDelay: '200ms' }}>
                        <div className="relative">
                            <div className="relative z-10 rounded-3xl overflow-hidden border border-border/50 bg-card/80 backdrop-blur-sm shadow-2xl">
                                ...
                                <div className="absolute bottom-0 left-0 right-0 p-8">
                                    <h3 className="text-2xl font-bold text-foreground mb-2">Cuidado Especializado</h3>
                                    <p className="text-muted-foreground">Conectando você aos melhores profissionais</p>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div className="absolute bottom-0 left-0 right-0">
                <svg className="w-full h-16 fill-card" viewBox="0 0 1440 48" xmlns="http://www.w3.org/2000/svg">
