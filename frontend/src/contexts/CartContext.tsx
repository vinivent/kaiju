    ...
    setItems((prevItems) => {
      ...
      if (existingItem) {
        ...
        if (newQuantity > product.stockQuantity) {
          toast.error(
            `Quantidade indisponível. Apenas ${product.stockQuantity} unidades em estoque.`,
            {
        ...
        const itemId = `${product.productId}-${prevItems.length}-${Math.random()
          .toString(36)
          .substr(2, 9)}`;
        return [
          ...prevItems,
    ...
    (productId: string, quantity: number) => {
      ...
      setItems((prevItems) => {
        ...
        if (quantity > item.stockQuantity) {
          toast.error(
            `Quantidade indisponível. Apenas ${item.stockQuantity} unidades em estoque.`,
            {
